 ...
 */
export default class MatchEventsEmitter extends EventsEmitterBase {
    /**
     ...
     */
    public emitWinRoundsNumberResponse(numWinRound: number) {
        this.socket.emit('win-rounds-number-response', numWinRound);
    }
}